...
import "./webworkerAll-DZdq3xCd.js";
import "./index-BgAwOX9Q.js";
import "./canvasUtils-Dmnz5saj.js";
import "./Filter-DmRrYMet.js";
class q {
    constructor(e) {
        this._lastTransform = "", this._observer = null, this._tickerAttached = !1, this.updateTranslation = () => {
            ...
            const t = this._canvas.getBoundingClientRect(),
                ...
                n = t.width / i * this._renderer.resolution,
                o = t.height / s * this._renderer.resolution,
                r = t.left,
                h = t.top,
                d = `translate(${r}px, ${h}px) scale(${n}, ${o})`;
        ...
        "ResizeObserver" in globalThis ? (this._observer && (this._observer.disconnect(), this._observer = null), this._observer = new ResizeObserver(e => {
            for (const t of e) {
                ...
                const i = this.canvas.width,
                    ...
                    n = t.contentRect.width / i * this._renderer.resolution,
                    o = t.contentRect.height / s * this._renderer.resolution;
    ...
    var s = se(t),
        n = {
            apple: {
                phone: s(I) && !s(m),
                ipod: s(B),
                tablet: !s(I) && (s(C) || N(e)) && !s(m),
                universal: s(U),
                device: (s(I) || s(B) || s(C) || s(U) || N(e)) && !s(m)
            },
            amazon: {
                phone: s(E),
                tablet: !s(E) && s(M),
...
const ne = G.default ? ? G,
    oe = ne(globalThis.navigator),
    re = 9,
    W = 100,
    ae = 0,
    le = 0,
    ...
    L = class J {
        ...
        _deactivate() {
            ...
            if (!(!this._isActive || this._isMobileAccessibility)) {
                ...
                for (const i of this._children)(e = i._accessibleDiv) != null && e.parentNode && (i._accessibleDiv.parentNode.removeChild(i._accessibleDiv), i._accessibleDiv = null), i._accessibleActive = !1;
                for (const i in this._pools) this._pools[i].forEach(n => {
        ...
        _updateAccessibleObjects(e) {
            ...
            const t = e.children;
            if (t)
                for (let i = 0; i < t.length; i++) this._updateAccessibleObjects(t[i])
        }
        init(e) {
            const i = {
                accessibilityOptions: { ...J.defaultOptions,
        ...
        _dispatchEvent(e, t) {
            const {
                container: i
            } = e.target, s = this._renderer.events.rootBoundary, n = Object.assign(new O(s), {
                target: i
            });
...
class _e {
    ...
    mapEvent(e) {
        ...
        if (t)
            for (let i = 0, s = t.length; i < s; i++) t[i].fn(e);
        else y(`[EventBoundary]: Event mapping not defined for ${e.type}`)
    }
    hitTest(e, t) {
        _.pauseUpdate = !0;
        const s = this._isPointerMoveEvent && this.enableGlobalMoveEvents ? "hitTestMoveRecursive" : "hitTestRecursive",
            n = this[s](this.rootTarget, this.rootTarget.eventMode, me.set(e, t), this.hitTestFn, this.hitPruneFn);
        return n && n[0]
    }
    propagate(e, t) {
        if (!e.target) return;
    ...
    hitTestMoveRecursive(e, t, i, s, n, o = !1) {
        ...
        if ((e.eventMode === "dynamic" || t === "dynamic") && (_.pauseUpdate = !1), e.interactiveChildren && e.children) {
            ...
            for (let u = p.length - 1; u >= 0; u--) {
                const l = p[u],
                    v = this.hitTestMoveRecursive(l, this._isInteractive(t) ? t : l.eventMode, i, s, n, o || n(e, i));
                if (v) {
    ...
    hitTestRecursive(e, t, i, s, n) {
        ...
        if ((e.eventMode === "dynamic" || t === "dynamic") && (_.pauseUpdate = !1), e.interactiveChildren && e.children) {
            ...
            for (let p = h.length - 1; p >= 0; p--) {
                const u = h[p],
                    l = this.hitTestRecursive(u, this._isInteractive(t) ? t : u.eventMode, d, s, n);
                if (l) {
    ...
    hitPruneFn(e, t) {
        if (e.hitArea && (e.worldTransform.applyInverse(t, P), !e.hitArea.contains(P.x, P.y))) return !0;
        if (e.effects && e.effects.length)
            for (let i = 0; i < e.effects.length; i++) {
                const s = e.effects[i];
                if (s.containsPoint && !s.containsPoint(t, this.hitTestFn)) return !0
            }
        return !1
    }
    hitTestFn(e, t) {
    ...
    mapPointerMove(e) {
        ...
        if (((h = s.overTargets) == null ? void 0 : h.length) > 0 && n !== t.target) {
            const p = e.type === "mousemove" ? "mouseout" : "pointerout",
                u = this.createPointerEvent(e, p, n);
        ...
        if (n !== t.target) {
            ...
            if (!l || l === this.rootTarget.parent) {
                ...
                for (c.eventPhase = c.AT_TARGET; c.target && c.target !== n && c.target !== this.rootTarget.parent;) c.currentTarget = c.target, this.notifyTarget(c), i && this.notifyTarget(c, "mouseenter"), c.target = c.target.parent;
                this.freeEvent(c)
            }
            this.freeEvent(u)
        }
    ...
    _notifyListeners(e, t) {
        ...
        if (i)
            if ("fn" in i) i.once && e.currentTarget.removeListener(t, i.fn, void 0, !0), i.fn.call(i.context, e);
            else
                for (let s = 0, n = i.length; s < n && !e.propagationImmediatelyStopped; s++) i[s].once && e.currentTarget.removeListener(t, i[s].fn, void 0, !0), i[s].fn.call(i[s].context, e)
    }
}
const ge = 1,
    ye = {
...
const be = {
    ...
    dispatchEvent(a) {
        if (!(a instanceof O)) throw new Error("Container cannot propagate events outside of the Federated Events API");
