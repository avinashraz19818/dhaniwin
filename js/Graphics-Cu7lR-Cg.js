...
const C = class x {
    constructor(t) {
        this._renderer = t, this._managedContexts = new _({
            renderer: t,
            type: "resource",
    ...
    init(t) {
        x.defaultOptions.bezierSmoothness = (t == null ? void 0 : t.bezierSmoothness) ? ? x.defaultOptions.bezierSmoothness
    }
    ...
    updateGpuContext(t) {
        const e = t._gpuData,
            r = !!e[this._renderer.uid],
            s = e[this._renderer.uid] || this._initContext(t);
        return (t.dirty || !r) && (r && s.reset(), s.isBatchable = !1, t.dirty = !1), s
    }
    getGpuContext(t) {
    ...
    _initContextRenderData(t) {
        const e = new D,
            r = this.getGpuContext(t);
        return r.graphicsData = e, e.init(), e
    }
    _initContext(t) {
        const e = new P;
...
class y {
    constructor(t, e) {
        this.state = g.for2d(), this.renderer = t, this._adaptor = e, this.renderer.runners.contextChange.add(this), this._managedGraphics = new _({
            renderer: t,
            type: "renderable",
            priority: -1,
            name: "graphics"
...
class b {
    ...
    execute(t) {
        ...
        i.uTransformMatrix = t.groupTransform, i.uRound = e._roundPixels | t._roundPixels, R(t.groupColorAlpha, i.uColor, 0), this._adaptor.execute(this, t)
    }
    _rebuild(t) {
        const e = this._getGpuDataForRenderable(t),
            s = this.renderer.graphicsContext.updateGpuContext(t.context);
        e.destroy(), s.isBatchable && this._updateBatchesForRenderable(t, e)
    }
    _addToBatcher(t, e) {
        const r = this.renderer.renderPipes.batch,
            s = this._getGpuDataForRenderable(t).batches;
    ...
    _updateBatchesForRenderable(t, e) {
        const r = t.context,
            ...
            i = this.renderer._roundPixels | t._roundPixels;
        e.batches = n.batches.map(m => {
            const c = f.get(S);
            return m.copyTo(c), c.renderable = t, c.roundPixels = i, c
        })
    }
    destroy() {
...
class p extends w {
    constructor(t) {
        ...
        super({
            label: "Graphics",
            ...s
        }), this.renderPipeId = "graphics", e ? this.context = e : (this.context = this._ownedContext = new h, this.context.autoGarbageCollect = this.autoGarbageCollect), this.didViewUpdate = !0, this.allowChildren = !1, this.roundPixels = r ? ? !1
    }
    set context(t) {
    ...
    clone(t = !1) {
        return t ? new p(this._context.clone()) : (this._ownedContext = null, new p(this._context))
    }
    lineStyle(t, e, r) {
        a(o, "Graphics#lineStyle is no longer needed. Use Graphics#setStrokeStyle to set the stroke style.");
        const s = {};
        return t && (s.width = t), e && (s.color = e), r && (s.alpha = r), this.context.strokeStyle = s, this
    }
    beginFill(t, e) {
        a(o, "Graphics#beginFill is no longer needed. Use Graphics#fill to fill the shape with the desired style.");
        const r = {};
        return t !== void 0 && (r.color = t), e !== void 0 && (r.alpha = e), this.context.fillStyle = r, this
    }
    endFill() {
        a(o, "Graphics#endFill is no longer needed. Use Graphics#fill to fill the shape with the desired style."), this.context.fill();
        const t = this.context.strokeStyle;
        return (t.width !== h.defaultStrokeStyle.width || t.color !== h.defaultStrokeStyle.color || t.alpha !== h.defaultStrokeStyle.alpha) && this.context.stroke(), this
    }
    drawCircle(...t) {
        return a(o, "Graphics#drawCircle has been renamed to Graphics#circle"), this._callContextMethod("circle", t)
    }
    drawEllipse(...t) {
        return a(o, "Graphics#drawEllipse has been renamed to Graphics#ellipse"), this._callContextMethod("ellipse", t)
    }
    drawPolygon(...t) {
        return a(o, "Graphics#drawPolygon has been renamed to Graphics#poly"), this._callContextMethod("poly", t)
    }
    drawRect(...t) {
        return a(o, "Graphics#drawRect has been renamed to Graphics#rect"), this._callContextMethod("rect", t)
    }
    drawRoundedRect(...t) {
        return a(o, "Graphics#drawRoundedRect has been renamed to Graphics#roundRect"), this._callContextMethod("roundRect", t)
    }
    drawStar(...t) {
        return a(o, "Graphics#drawStar has been renamed to Graphics#star"), this._callContextMethod("star", t)
    }
}
export {
    p as G
