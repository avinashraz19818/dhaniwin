import {
    ...
    ay as tt,
    az as rt
} from "./init-WmWO7UEh.js";
import {
    F as st,
    S as nt
} from "./Filter-DmRrYMet.js";
import {
    c as at
} from "./colorToUniform-DUza8Qlq.js";
...
const j = class ge {
    constructor(e, t) {
        var r, s;
        this.state = nt.for2d(), this._batchersByInstructionSet = Object.create(null), this._activeBatches = Object.create(null), this.renderer = e, this._adaptor = t, (s = (r = this._adaptor).init) == null || s.call(r, this)
    }
    static getBatcher(e) {
    ...
    buildStart(e) {
        ...
        t || (t = this._batchersByInstructionSet[e.uid] = Object.create(null), t.default || (t.default = new le({
...
j.extension = {
    type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes],
    name: "batch"
};
    ...
    execute(e) {
        ...
        if (e.action === "pushMaskBegin") {
            ...
            if (s.inverse = e.inverse, s.channel = e.mask.channel, r) {
                ...
                const n = $e(e.mask.mask, !0, dt);
                e.mask.mask.measurable = !1, n.ceil();
                const i = t.renderTarget.renderTarget.colorTexture.source,
                    o = T.getOptimalTexture(n.width, n.height, i._resolution, i.antialias);
...
class Te {
    ...
    execute(e) {
        ...
        const r = this._renderer,
            s = r,
            n = r.renderTarget.renderTarget.uid;
...
class ye {
    ...
    _executeCacheAsTexture(e) {
        if (e.textureNeedsUpdate) {
            ...
            const t = new m().translate(-e._textureBounds.x, -e._textureBounds.y);
...
function Me(a, e = !1) {
    ...
    for (const s in t) {
        ...
        for (let h = 0; h < d; h++) {
            const c = o[h];
            c.parentRenderGroup === a && c.relativeRenderGroupDepth === n && Re(c, r, 0)
        }
        F(o, d), i.index = 0
    }
    if (e)
        for (let s = 0; s < a.renderGroupChildren.length; s++) Me(a.renderGroupChildren[s], e)
}
...
function ht(a) {
    ...
    if (a.renderGroupParent) {
        ...
        a.worldTransform.appendFrom(e.relativeGroupTransform, r.worldTransform), a.worldColor = he(e.groupColor, r.worldColor), t = e.groupAlpha * r.worldAlpha
...
function Re(a, e, t) {
    ...
    const s = a.parent;
    if (s && !s.renderGroup ? (t |= a._updateFlags, a.relativeGroupTransform.appendFrom(r, s.relativeGroupTransform), t & ne && ae(a, s, t)) : (t = a._updateFlags, a.relativeGroupTransform.copyFrom(r), t & ne && ae(a, ct, t)), !a.renderGroup) {
        const n = a.children,
            i = n.length;
        for (let h = 0; h < i; h++) Re(n[h], e, t);
...
function ae(a, e, t) {
    if (t & pe) {
        a.groupColor = he(a.localColor, e.groupColor);
        let r = a.localAlpha * e.groupAlpha;
        r = r < 0 ? 0 : r > 1 ? 1 : r, a.groupAlpha = r, a.groupColorAlpha = a.groupColor + ((r * 255 | 0) << 24)
    }
    t & me && (a.groupBlendMode = a.localBlendMode === "inherit" ? e.groupBlendMode : a.localBlendMode), t & fe && (a.globalDisplayStatus = a.localDisplayStatus & e.globalDisplayStatus), a._updateFlags = 0
}

function ft(a, e) {
    const {
        list: t
    } = a.childrenRenderablesToUpdate;
    let r = !1;
...
class Se {
        ...
        if (e.invalidateMatrices(), e.isCachedAsTexture) {
            if (e.textureNeedsUpdate) {
                const r = e.root.getLocalBounds(),
                    ...
                    i = e.textureOptions.antialias ? ? s.view.antialias,
                    o = e.textureOptions.scaleMode ? ? "linear",
                    d = e.texture;
                r.ceil(), e.texture && T.returnTexture(e.texture, !0);
                const h = T.getOptimalTexture(r.width, r.height, n, i);
                h._source.style = new Ke({
                    scaleMode: o
                }), e.texture = h, e._textureBounds || (e._textureBounds = new z), e._textureBounds.copyFrom(r), d !== e.texture && e.renderGroupParent && (e.renderGroupParent.structureDidChange = !0)
            }
    ...
    _updateRenderGroups(e) {
        ...
        if (e.runOnRender(t), e.instructionSet.renderPipes = r, e.structureDidChange ? F(e.childrenRenderablesToUpdate.list, 0) : ft(e, r), Me(e), e.structureDidChange ? (e.structureDidChange = !1, this._buildInstructions(e, t)) : this._updateRenderables(e), e.childrenRenderablesToUpdate.index = 0, t.renderPipes.batch.upload(e.instructionSet), !(e.isCachedAsTexture && !e.textureNeedsUpdate))
            for (let s = 0; s < e.renderGroupChildren.length; s++) this._updateRenderGroups(e.renderGroupChildren[s])
    }
...
const $ = class we {
    ...
    set color(e) {
        E.shared.setValue(e).alpha < 1 && this._backgroundColor.alpha === 1 && ce("Cannot set a transparent background on an opaque canvas. To enable transparency, set backgroundAlpha < 1 when initializing your Application."), this._backgroundColor.setValue(e)
    }
    get alpha() {
...
const I = {
    ...
    q = class Pe {
        ...
        async base64(e) {
            ...
            if (s.toDataURL !== void 0) return s.toDataURL(I[t], r);
        ...
        canvas(e) {
            ...
            const t = e.target,
                r = this._renderer;
            if (t instanceof p) return r.texture.generateCanvas(t);
        ...
        pixels(e) {
            ...
            const t = e.target,
                r = this._renderer,
                s = t instanceof p ? t : r.textureGenerator.generateTexture(e),
        ...
        log(e) {
            const t = e.width ? ? 200;
            e = this._normalizeOptions(e);
            const s = this.canvas(e).toDataURL(),
                n = ["font-size: 1px;", `padding: ${t}px 300px;`, `background: url(${s}) no-repeat;`, "background-size: contain;"].join(" ")
        }
        destroy() {
            this._renderer = null
        }
...
class Be {
    ...
    generateTexture(e) {
        ...
        const i = ((c = e.frame) == null ? void 0 : c.copyTo(_t)) || Ye(s, xt).rectangle,
            o = e.defaultAnchor && {
                defaultAnchor: e.defaultAnchor
            };
        i.width = Math.max(i.width, 1 / t) | 0, i.height = Math.max(i.height, 1 / t) | 0;
        const d = K.create({ ...e.textureSourceOptions,
                width: i.width,
                height: i.height,
                resolution: t,
                antialias: r,
...
const Y = class Ge {
    ...
    init(e) {
        e = { ...Ge.defaultOptions,
            ...e
        }, this.maxUnusedTime = e.gcMaxUnusedTime, this._frequency = e.gcFrequency, this.enabled = e.gcActive, this.now = performance.now()
    }
    get enabled() {
    ...
    run() {
        ...
        for (const s of t) this.runOnHash(s, e);
        let r = 0;
    ...
    updateRenderableGCTick(e, t) {
        ...
        const r = e.renderGroup ? ? e.parentRenderGroup,
            s = ((n = r == null ? void 0 : r.instructionSet) == null ? void 0 : n.gcTick) ? ? -1;
        ...
        for (const c in i) {
            ...
            if (n === "renderable" && this.updateRenderableGCTick(u, t), !(t - u._gcLastUsed < this.maxUnusedTime) && u.autoGarbageCollect) {
                if (o || (d + 1 !== 1e4 ? (i[c] = null, d++) : o = this._createHashClone(i, c)), n === "renderable") {
                    const _ = u,
                        x = _.renderGroup ? ? _.parentRenderGroup;
...
class Ue {
    ...
    bind({
        ...
        const c = h.uniforms;
        c.uProjectionMatrix = d.projectionMatrix, c.uResolution = d.resolution, c.uWorldTransformMatrix.copyFrom(d.worldTransformMatrix), c.uWorldTransformMatrix.tx -= d.offset.x, c.uWorldTransformMatrix.ty -= d.offset.y, at(d.worldColor, c.uWorldColorAlpha, 0), h.update();
        let u;
        this._renderer.renderPipes.uniformBatch ? u = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(h, !1) : (u = this._bindGroupPool.pop() || new Je, this._activeBindGroups.push(u), u.setResource(h, 0)), d.bindGroup = u, this._currentGlobalUniformData = d
    }
    push(e) {
...
function kt(a) {
    if (!ie) {
        if (N.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
            const e = [`%c  %c  %c  %c  %c PixiJS %c v${re} (${a}) http://www.pixijs.com/
...
const De = class Ee {
    constructor(e = {}) {
        if (this.uid = Ze("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = !1, this._size = new Float32Array(2), this._managedColorTextures = !1, e = { ...Ee.defaultOptions,
                ...e
            }, this.stencil = e.stencil, this.depth = e.depth, this.isRoot = e.isRoot, typeof e.colorTextures == "number") {
            this._managedColorTextures = !0;
            for (let t = 0; t < e.colorTextures; t++) this.colorTextures.push(new v({
                width: e.width,
                height: e.height,
        ...
        this.colorTexture.source.on("resize", this.onSourceResize, this), (e.depthStencilTexture || this.stencil) && (e.depthStencilTexture instanceof p || e.depthStencilTexture instanceof v ? this.depthStencilTexture = e.depthStencilTexture.source : this.ensureDepthStencilTexture())
    }
    get size() {
        const e = this._size;
...
const Q = class Le {
    ...
    init(e) {
        e = { ...Le.defaultOptions,
            ...e
        }, e.view && (f(et, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new B(0, 0, e.width, e.height), this.canvas = e.canvas || N.get().createCanvas(), this.antialias = !!e.antialias, this.texture = Oe(this.canvas, e), this.renderTarget = new H({
...
let St = Q;
const At = [mt, Ue, X, St, Se, yt, Rt, Be, gt, tt, Mt, Ae],
    It = [ke, _e, Ce, ye, xe, Te, be, ve];
...
class Dt {
    constructor(e) {
        this.rootViewPort = new B, this.viewport = new B, this.mipLevel = 0, this.layer = 0, this.onRenderTargetChange = new rt("onRenderTargetChange"), this.projectionMatrix = new m, this.defaultClearColor = [0, 0, 0, 0], this._renderSurfaceToRenderTargetHash = new Map, this._gpuRenderTargetHash = Object.create(null), this._renderTargetStack = [], this._renderer = e, e.gc.addCollection(this, "_gpuRenderTargetHash", "hash")
    }
    finishRenderPass() {
    ...
    renderStart({
        ...
        var o, d;
        this._renderTargetStack.length = 0, this.push(e, t, r, s, n ? ? 0, i ? ? 0), this.rootViewPort.copyFrom(this.viewport), this.rootRenderTarget = this.renderTarget, this.renderingToScreen = Pt(this.rootRenderTarget), (d = (o = this.adaptor).prerender) == null || d.call(o, this.rootRenderTarget)
    }
    postrender() {
        var e, t;
    ...
    bind(e, t = !0, r, s, n = 0, i = 0) {
        ...
        const c = o.colorTexture,
            u = this.viewport,
            G = c.arrayLayerCount || 1;
        if ((i | 0) !== i && (i |= 0), i < 0 || i >= G) throw new Error(`[RenderTargetSystem] layer ${i} is out of bounds (arrayLayerCount=${G}).`);
        this.mipLevel = n | 0, this.layer = i | 0;
        const _ = Math.max(c.pixelWidth >> n, 1),
            x = Math.max(c.pixelHeight >> n, 1);
        if (!s && e instanceof p && (s = e.frame), s) {
            const C = c._resolution,
                k = 1 << Math.max(n | 0, 0),
                Fe = s.x * C + .5 | 0,
                He = s.y * C + .5 | 0,
                We = s.width * C + .5 | 0,
                ze = s.height * C + .5 | 0;
            let M = Math.floor(Fe / k),
                R = Math.floor(He / k),
                U = Math.ceil(We / k),
                A = Math.ceil(ze / k);
        ...
        } else u.x = 0, u.y = 0, u.width = _, u.height = x;
        return wt(this.projectionMatrix, 0, 0, u.width / c.resolution, u.height / c.resolution, !o.isRoot), this.adaptor.startRenderPass(o, t, r, u, n, i), d && this.onRenderTargetChange.emit(o), o
    }
    ...
    _initRenderTarget(e) {
        let t = null;
        return O.test(e) && (e = Oe(e).source), e instanceof H ? t = e : e instanceof v && (t = new H({
            colorTextures: [e]
...
export {
    xe as A, ke as B, ve as C, Dt as R, At as S, _e as a, Ce as b, ye as c, It as d
};